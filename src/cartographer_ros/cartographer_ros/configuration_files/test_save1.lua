...
TRAJECTORY_BUILDER_2D.use_online_correlative_scan_matching = true --im nelkulhoz
...
TRAJECTORY_BUILDER_2D.imu_gravity_time_constant = 500
...
MAP_BUILDER.pose_graph.optimization_problem.huber_scale = 20.0
MAP_BUILDER.pose_graph.optimize_every_n_nodes = 5
--MAP_BUILDER.pose_graph.constraint_builder.sampling_ratio = 0.99
--MAP_BUILDER.pose_graph.global_sampling_ratio = 0.9
...
MAP_BUILDER.pose_graph.constraint_builder.global_localization_min_score = 0.60
...
--MAP_BUILDER.pose_graph.constraint_builder.fast_correlative_scan_matcher_3d.angular_search_window = math.rad(1.)
